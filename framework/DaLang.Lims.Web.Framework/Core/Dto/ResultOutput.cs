...
public class ResultOutput<T> : IResultOutput<T>
{
    ...
    /// <param name="data">数据</param>
    /// <returns></returns>
    public ResultOutput<T> Fail(string msg = null, T data = default)
    {
        Success = false;
        Msg = msg;
        Data = data;
...
public static partial class ResultOutput
{
    ...
    /// <param name="data">数据</param>
    /// <returns></returns>
    public static IResultOutput<T> Fail<T>(string msg = null, T data = default)
    {
        return new ResultOutput<T>().Fail(msg, data);
    }
    ...
    /// <param name="msg">消息</param>
    /// <returns></returns>
    public static IResultOutput<string> Fail(string msg = null)
    {
        return new ResultOutput<string>().Fail(msg);
    }
