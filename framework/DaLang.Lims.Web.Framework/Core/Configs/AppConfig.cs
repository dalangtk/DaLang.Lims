...
namespace DaLang.Lims.Web.Framework.Core.Configs;
...
public class AppConfig
{
    ...
    /// 使用.net core内置依赖注入容器
    /// </summary>
    public bool AutofacInject { get; set; } = true;
    ...
    /// 资源认证
    /// </summary>
    public BasicAuthenticationConfig BasicAuthentication { get; set; }
}
...
{
    public string CachePrefix { get; set; } = "dalang.lims.web:workerid:";
}
public class BasicAuthenticationConfig : AuthenticationSchemeOptions
{
    public bool Enable { get; set; } = false;
