...
public class DbConfig
{
    ...
    public void PostConfigure(DbConfig options, IConfiguration configuration)
    {
        foreach (var dbConfig in options.ConnectionConfigs)
        {
            if (dbConfig.ConfigId == null || string.IsNullOrWhiteSpace(dbConfig.ConfigId.ToString()))
                dbConfig.ConfigId = DbKeys.MainConfigId;
        }
    }
    ...
    public sealed class SeedSettings
    {
        ...
        /// 初始化种子数据的表
        /// </summary>
        public List<string> SyncDataIncludeTables { get; set; }
    }
