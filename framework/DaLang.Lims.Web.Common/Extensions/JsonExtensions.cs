...
public static partial class JsonExtensions
{
    ...
    ///     <see cref="object" />
    /// </returns>
    public static object? As(this JsonNode? jsonNode, Type resultType,
    ...
    public static object GetNumericValue(this JsonNode jsonNode)
    {
        // 空检查
    ...
    ///     <see cref="JsonNode" />
    /// </returns>
    public static JsonNode? TransformKeysWithNamingPolicy(this JsonNode? jsonNode, JsonNamingPolicy jsonNamingPolicy)
    {
        // 空检查
    ...
    ///     <see cref="bool" />
    /// </returns>
    public static bool TryGetDateValue(this JsonNode? jsonNode, out DateTime dateTime)
    {
