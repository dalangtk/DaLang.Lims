...
public static class CommonHelper
{
    ...
    public static async Task<string> UploadFile(string filePath, string apiUrl, long examInfoId, bool isGross,string accessToken)
    {
        ...
        Console.WriteLine($"正在上传文件: {Path.GetFileName(filePath)} 到 {apiUrl} ...");
