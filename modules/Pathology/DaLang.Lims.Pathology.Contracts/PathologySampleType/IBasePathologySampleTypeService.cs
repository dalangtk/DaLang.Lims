...
namespace DaLang.Lims.Pathology.Contracts.PathologySampleType;
...
public interface IBasePathologySampleTypeService
{
    ...
    /// 分页查询
    /// </summary>
    Task<PageOutput<BasePathologySampleTypeDto>> GetPageWithoutChildrenAsync(PageInput<BasePathologySampleTypeQueryInput> input);
